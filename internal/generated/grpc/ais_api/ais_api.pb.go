...
type PublishAisAccountRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	AccountId     uint64                 `protobuf:"varint,1,opt,name=account_id,json=accountId,proto3" json:"account_id,omitempty"`
	AccountName   string                 `protobuf:"bytes,2,opt,name=account_name,json=accountName,proto3" json:"account_name,omitempty"`
	AccountType   AccountType            `protobuf:"varint,3,opt,name=account_type,json=accountType,proto3,enum=ais_api.AccountType" json:"account_type,omitempty"`
...
func (x *PublishAisAccountRequest) Reset() {
	*x = PublishAisAccountRequest{}
	mi := &file_api_ais_api_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PublishAisAccountRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PublishAisAccountRequest) ProtoMessage() {}

func (x *PublishAisAccountRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_ais_api_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PublishAisAccountRequest.ProtoReflect.Descriptor instead.
func (*PublishAisAccountRequest) Descriptor() ([]byte, []int) {
	return file_api_ais_api_proto_rawDescGZIP(), []int{2}
}

func (x *PublishAisAccountRequest) GetAccountId() uint64 {
	if x != nil {
		return x.AccountId
	}
	return 0
...
func (x *PublishAisAccountRequest) GetAccountName() string {
	if x != nil {
		return x.AccountName
	}
	return ""
...
func (x *PublishAisAccountRequest) GetAccountType() AccountType {
	if x != nil {
		return x.AccountType
	}
	return AccountType_CASA
...
func (x *PublishAisAccountRequest) GetAccountStatus() Status {
	if x != nil {
		return x.AccountStatus
	}
	return Status_active
...
type PublishAisAccountResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *PublishAisAccountResponse) Reset() {
	*x = PublishAisAccountResponse{}
	mi := &file_api_ais_api_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PublishAisAccountResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PublishAisAccountResponse) ProtoMessage() {}

func (x *PublishAisAccountResponse) ProtoReflect() protoreflect.Message {
	mi := &file_api_ais_api_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PublishAisAccountResponse.ProtoReflect.Descriptor instead.
func (*PublishAisAccountResponse) Descriptor() ([]byte, []int) {
	return file_api_ais_api_proto_rawDescGZIP(), []int{3}
}
...
var file_api_ais_api_proto_rawDesc = string([]byte{
	...
	0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0xcd, 0x01, 0x0a, 0x18, 0x50, 0x75, 0x62, 0x6c, 0x69,
	0x73, 0x68, 0x41, 0x69, 0x73, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x75,
	...
	,
})
...
var file_api_ais_api_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_api_ais_api_proto_goTypes = []any{
	...
	(*PublishAisAccountRequest)(nil),  // 4: ais_api.PublishAisAccountRequest
	(*PublishAisAccountResponse)(nil), // 5: ais_api.PublishAisAccountResponse
}
var file_api_ais_api_proto_depIdxs = []int32{
	...
	1, // 2: ais_api.PublishAisAccountRequest.account_type:type_name -> ais_api.AccountType
	0, // 3: ais_api.PublishAisAccountRequest.account_status:type_name -> ais_api.Status
	2, // 4: ais_api.AISService.GetAisAccountByID:input_type -> ais_api.GetAccountStatusRequest
	4, // 5: ais_api.AISService.PublishAisAccount:input_type -> ais_api.PublishAisAccountRequest
	3, // 6: ais_api.AISService.GetAisAccountByID:output_type -> ais_api.GetAccountStatusResponse
	5, // 7: ais_api.AISService.PublishAisAccount:output_type -> ais_api.PublishAisAccountResponse
